...
Variable* createVariable (char* name, char* type, double value, int scope) 
{
...
double searchkeylist(List* tosearch, char* key)
{
    No* iternode;
...
int updatelist(List* toupdate, char* key, double value)
{
    No* iternode;
