...
,	printf("Encontramos uma vírgula: \"%s\"\n", yytext);

&	printf("Econtramos um AND ou 'Endereço de': \"%s\"\n", yytext);
...
"-" |
"/" |
"*"	printf("Encontramos uma operação: \"%s\"\n", yytext); 

{IDENTIFICADOR}	printf("Econtramos um identificador: \"%s\"\n", yytext); 
